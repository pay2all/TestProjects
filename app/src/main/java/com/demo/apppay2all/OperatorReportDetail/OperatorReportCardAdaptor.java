...
public class OperatorReportCardAdaptor extends RecyclerView.Adapter<OperatorReportCardAdaptor.ViewHolder> {
    ...
    public OperatorReportCardAdaptor(Context context,List<OperatorReportItem> operatorReportItems){
        this.context=context;
        this.operatorReportItems=operatorReportItems;
    }

    @Override
    public int getItemCount() {

        return operatorReportItems==null?0:operatorReportItems.size();
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {

        OperatorReportItem item=operatorReportItems.get(position);
        holder.tetxview_provider_name.setText(item.getProvider_name());
        holder.textview_amount.setText("Rs "+item.getTotal_amount());
        holder.textview_total_profit.setText("Profit : "+item.getTotal_profit());
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.operator_report_item,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView tetxview_provider_name,textview_amount,textview_total_profit,textview_status;

        ImageView imageview_provider_image;
        ViewHolder(View view){
            super(view);

            tetxview_provider_name=view.findViewById(R.id.tetxview_provider_name);
            textview_amount=view.findViewById(R.id.textview_amount);
            textview_total_profit=view.findViewById(R.id.textview_total_profit);
    ...
    private void mShowrecipt (final int position) {
        ...
        textview_transctionid.setVisibility(View.GONE);
        textview_rechargemount.setText(item.getTotal_amount());
        textview_newbalance.setVisibility(View.GONE);
        textview_comission.setText(item.getTotal_profit());
        textview_dateandtime.setText(item.getDate());
        textview_customernumber.setVisibility(View.GONE);
