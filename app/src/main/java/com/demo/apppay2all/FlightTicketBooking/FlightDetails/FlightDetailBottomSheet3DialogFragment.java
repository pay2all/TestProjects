...
public class FlightDetailBottomSheet3DialogFragment extends BottomSheetDialogFragment {

    private BottomSheetBehavior mBehavior;

    public static FlightDetailBottomSheet3DialogFragment dialogFragment;
