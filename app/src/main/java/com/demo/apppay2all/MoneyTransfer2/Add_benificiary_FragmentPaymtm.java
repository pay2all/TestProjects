                ...
                if(locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER))
                {
                    if (DetectConnection.checkInternetConnection(getContext())) {
                        ...
                        if (textview_bank_name.getText().toString().toLowerCase().equals("bank name") || textview_bank_name.getText().toString().equalsIgnoreCase("Select Bank")) {
                            ...
                            String sending_url = BaseURL.BASEURL_B2C + "api/dmt/v2/account-validate";
                            ...
                            builder.appendQueryParameter("sender_id", senderid);
...
//                            Add_Beneficiary(beneficiary_number, valid_name, account_number, ifsc);
                            ...
                            String sending_url=BaseURL.BASEURL_B2C+"api/dmt/v2/add-beneficiary";
                            Uri.Builder builder=new Uri.Builder();
                            builder.appendQueryParameter("api_token", SharePrefManager.getInstance(getActivity()).mGetApiToken());
                            builder.appendQueryParameter("bank_id", bank_code);
                            builder.appendQueryParameter("ifsc_code", ifsc);
    ...
    protected void Add_Beneficiary(final String sender_number, final String name, final String account_number, final String ifsc) {
        class Add_data extends AsyncTask<String, String, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    URL url = new URL(BaseURL.BASEURL+"app/v2/add-beneficiary?mobile_number="+sender_number+"&bank_code="+bank_code+"&ifsc="+ifsc+"&beneficiary_mobile="+beneficiary_number+"&beneficiary_account="+account_number+"&sender_id="+senderid+"&beneficiary_name="+name);
...
//                BaseURL.BASE_URL+"app/v2/check-beneficiary-name?username="+username+"&password="+password+"&mobile_number="+sender_number+"&bank_id="+bank_code+"&ifsc="+ifsc+"&beneficiary_account="+account_number,
...
//                JSONObject data=jsonObject.getJSONObject("data");
                ...
                if (jsonObject.has("name")) {
                    recipient_name = jsonObject.getString("name");
                }
