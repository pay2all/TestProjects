    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_resend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sending_url=BaseURL.BASEURL_B2C+"api/dmt/v1/resend-otp";
                ...
                builder.appendQueryParameter("api_token", SharePrefManager.getInstance(SenderActivity.this).mGetApiToken());
            ...
            public void onClick(View view) {
                ...
                if (DetectConnection.checkInternetConnection(SenderActivity.this)){
                        ...
                        if (editText_mobileno.getText().toString().equals("")){
                            ...
                            Toast.makeText(SenderActivity.this, "Please enter a valid mobile number", Toast.LENGTH_SHORT).show();
...
//                            CheckRegistrationStatus(number_tobecheck);
                            ...
                            String sending_url=BaseURL.BASEURL_B2C+"api/dmt/v1/get-customer";
                            Uri.Builder builder=new Uri.Builder();
                            builder.appendQueryParameter("api_token", SharePrefManager.getInstance(SenderActivity.this).mGetApiToken());
                            builder.appendQueryParameter("mobile_number",number_tobecheck);
                    ...
                    Toast.makeText(SenderActivity.this, "No Connection", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        button_continue.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if (regiteration_status.equalsIgnoreCase("Verification pending")) {
                    Toast.makeText(SenderActivity.this, "Verification pending", Toast.LENGTH_SHORT).show();
                }
                else if (regiteration_status.equalsIgnoreCase("have to be enter otp"))
                {
                    ...
                    if (DetectConnection.checkInternetConnection(SenderActivity.this)) {
                        if (editText_otp.getText().toString().equals("")) {
                            Toast.makeText(SenderActivity.this, "Enter OTP", Toast.LENGTH_SHORT).show();
...
//                            Otp_verification(number_tobecheck, string_otp);
                            ...
                            String sending_url=BaseURL.BASEURL_B2C+"api/dmt/v1/sender-confirmation";
                            Uri.Builder builder=new Uri.Builder();
                            builder.appendQueryParameter("api_token", SharePrefManager.getInstance(SenderActivity.this).mGetApiToken());
                            builder.appendQueryParameter("mobile_number",number_tobecheck);
                ...
                } else if (regiteration_status.equalsIgnoreCase("not register"))
                {
...

                    {
                        if (editText_fname.getText().toString().equals("")) {
                            Toast.makeText(SenderActivity.this, "Enter first name", Toast.LENGTH_SHORT).show();
                        }
                        else if (editText_lname.getText().toString().equals(""))
                        {
                            Toast.makeText(SenderActivity.this, "Enter Last name", Toast.LENGTH_SHORT).show();
                        }
                        else if (edittext_pincode.getText().toString().equals(""))
                        {
                            Toast.makeText(SenderActivity.this, "Enter PIN Code", Toast.LENGTH_SHORT).show();
                        }
                        else if (edittext_address.getText().toString().equals(""))
                        {
                            Toast.makeText(SenderActivity.this, "Please Enter address", Toast.LENGTH_SHORT).show();
                        }
                        else if (edittext_state.getText().toString().equals(""))
                        {
                            Toast.makeText(SenderActivity.this, "Please Enter State name", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            String firstname = editText_fname.getText().toString();
                            ...
                            String sending_url=BaseURL.BASEURL_B2C+"api/dmt/v1/add-sender";
                            Uri.Builder builder=new Uri.Builder();
                            builder.appendQueryParameter("api_token", SharePrefManager.getInstance(SenderActivity.this).mGetApiToken());
                            builder.appendQueryParameter("mobile_number",number_tobecheck);
                            builder.appendQueryParameter("first_name",firstname);
...
//            }
        ...
        if (status.equalsIgnoreCase("success")) {
            ...
            Intent intent=new Intent(SenderActivity.this, Sender_allready_RegisterPaytm.class);
...
//    }
    ...
    protected void mCheckSender(final String type, Uri.Builder builder, String sending_url)
    {
        ...
        new CallResAPIPOSTMethod(SenderActivity.this,builder,sending_url,true,"POST"){
            @Override
